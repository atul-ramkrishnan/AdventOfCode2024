...
for antenna1 in locations:
    for antenna2 in locations:
        if antenna1[2] == antenna2[2] and antenna1[2] != '.' and antenna1 != antenna2:
            ...
            d = distance_squared(antenna1[0], antenna1[1], antenna2[0], antenna2[1])

            for antinode in locations:
                if antinode != antenna1 and antinode != antenna2 and m == slope(antenna1[0], antenna1[1], antinode[0], antinode[1]) and \
                (d == distance_squared(antenna1[0], antenna1[1], antinode[0], antinode[1]) or d == distance_squared(antenna2[0], antenna2[1], antinode[0], antinode[1])):
